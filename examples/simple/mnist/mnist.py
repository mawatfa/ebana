...
def train(arg_dict):
    ...
    # output dense layer
    d_out = DenseLayer(units=2*output_units, lr=lr2, name="d_out", initializer=weight_initialzier, trainable=ARGS['layer_2_trainable'], grad_func=grad_func)(g1)
